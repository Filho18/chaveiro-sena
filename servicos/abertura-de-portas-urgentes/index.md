...
- Habitação: apartamentos, moradias, quartos
- Comercial: escritórios, lojas, armazéns
- Viaturas: automóveis, carrinhas
- Especiais: fechaduras multipontos, chave partida no cilindro, alojamento local

## Tabela de Preços

| Serviço | Preço mínimo |
|---------|-------------|
| Abertura simples (dia útil) | 60€ |
| Abertura noturna / fim de semana | 80€ |
| Fechadura multipontos | 90€ |
| Extração de chave partida | 70€ |
